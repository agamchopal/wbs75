        ...
        if st.sidebar.button('Show Analysis'):
            ...
            if selected == 'Emoji':
                try:
                    ...
                    with col1:
                        try:
                            st.write("<h1 style='text-align: center;'>Pie chart showing the percentage of positive,neutral and negative sentiments</h1>", #font-size: 16px;'>User 1</h1>",
                                     unsafe_allow_html=True)
...
if selected == "Dashboard":
    ...
    st.write(
        "<h1 style='text-align: center;'>User to User comparision</h1>",
    ...
    st.write(
        ...
        unsafe_allow_html=True)
    st.write(
        "<h3 style='text-align: left;'>1: Write (name,name of first user,name of second user) for    Pie-Chart and Scatter Plot comparision.</h3",
        # font-size: 16px;'>User 1</h1>",
        unsafe_allow_html=True)
    st.write(
        "<h3 style='text-align: left;'>2: Write (user,name of first user,name of second user) for wordcloud,Types of Words,Similar users and text summary comparision.</h3",
